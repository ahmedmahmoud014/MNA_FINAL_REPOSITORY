//
//  TestRegulaViewController.swift
//  Mofa
//
//  Created by mac bokk pro on 2018-09-11.
...
class TestRegulaViewController: BaseController {
   ...
   // var docReader: DocReader?
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
     //   self.initializationReader(viewController :  TestRegulaViewControllerviewController)

    //    initializationReader()
        
       // self.docReader?.processParams.scenario = "Barcode"
...
//        let ft_Document = result.getTextFieldValueByType(fieldType: .ft_Document_Number)
//            print(" tessssss  \(ft_Document)")
...
//extension TestRegulaViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//}
//
//extension TestRegulaViewController: UIPickerViewDataSource {
...
//}
//
//extension TestRegulaViewController: UIPickerViewDelegate {
...
//        print("identifierrrrr \( docReader.availableScenarios[row].identifier)")
//        self.docReader?.processParams.scenario = "Mrz"
//    }
//}
